...
urlpatterns = [
    ...
    path(
        "chapters/<int:chapter_pk>/members/",
        MemberViewSet.as_view({"get": "list", "post": "create"}),
        name="chapter-members-list",
    ),
    path(
        "chapters/<int:chapter_pk>/members/<int:pk>/",
    ...
    path(
        "chapters/<int:chapter_id>/reports/<int:report_id>/referral-matrix/",
        MatrixViewSet.as_view({"get": "referral_matrix"}),
        name="report-referral-matrix",
    ),
    path(
        "chapters/<int:chapter_id>/reports/<int:report_id>/one-to-one-matrix/",
        MatrixViewSet.as_view({"get": "one_to_one_matrix"}),
        name="report-oto-matrix",
    ),
    path(
        "chapters/<int:chapter_id>/reports/<int:report_id>/combination-matrix/",
    ...
    path(
        "chapters/<int:chapter_id>/reports/<int:report_id>/compare/<int:previous_report_id>/",
        ComparisonViewSet.as_view({"get": "compare_comprehensive"}),
        name="report-compare-comprehensive",
    ),
    path(
        "chapters/<int:chapter_id>/reports/<int:report_id>/compare/<int:previous_report_id>/referrals/",
        ComparisonViewSet.as_view({"get": "compare_referral"}),
        name="report-compare-referral",
    ),
    path(
        "chapters/<int:chapter_id>/reports/<int:report_id>/compare/<int:previous_report_id>/one-to-ones/",
        ComparisonViewSet.as_view({"get": "compare_oto"}),
        name="report-compare-oto",
    ),
    path(
        "chapters/<int:chapter_id>/reports/<int:report_id>/compare/<int:previous_report_id>/combination/",
        ComparisonViewSet.as_view({"get": "compare_combination"}),
        name="report-compare-combination",
    ),
    path(
        "chapters/<int:chapter_id>/reports/<int:report_id>/compare/<int:previous_report_id>/download-excel/",
