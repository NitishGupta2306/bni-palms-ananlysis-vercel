"""
One-to-One (OTO) Matrix Excel Formatter.

Handles formatting for OTO matrix sheets with:
...
- Yellow highlighting on non-zero OTO values
...
def write_oto_matrix(worksheet, aggregated_matrix, period_str: str, stats: dict, reports: list):
    """
    Write OTO matrix with monthly breakdowns and performance highlighting.

    Args:
        worksheet: The worksheet to write to
        aggregated_matrix: DataFrame or dict with aggregated OTO data
        period_str: Period display string (e.g., "01/2025 - 03/2025")
        stats: Chapter statistics dict with keys:
            - oto_totals: Dict of {member_name: total_otos}
            - avg_oto: Chapter average OTOs
