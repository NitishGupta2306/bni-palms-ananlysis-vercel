              ...
              <CardContent className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="border rounded-lg overflow-hidden">
                      <button
                        onClick={() =>
                          setExpandedMatrix(
                            expandedMatrix === "referral" ? null : "referral",
                          )
                        }
                        className="w-full flex items-center justify-between p-4 hover:bg-muted/50 transition-colors"
                      >
                        <div className="flex items-center gap-3">
                          <Badge variant="secondary">Referral Matrix</Badge>
                        ...
                        <ChevronDown
                          className={cn(
                            ...
                            expandedMatrix === "referral" && "rotate-180",
                          )}
                        />
                      </button>
                      {expandedMatrix === "referral" && (
                        <div className="p-4 border-t bg-muted/30">
                          <p className="text-sm text-muted-foreground">
                            Matrix preview will be displayed here. This would
                            show the referral matrix data in a table format.
                          </p>
                        </div>
                      )}
                    </div>
                    ...
                    <div className="border rounded-lg overflow-hidden">
                      <button
                        onClick={() =>
                          setExpandedMatrix(
                            expandedMatrix === "oto" ? null : "oto",
                          )
                        }
                        className="w-full flex items-center justify-between p-4 hover:bg-muted/50 transition-colors"
                      >
                        <div className="flex items-center gap-3">
                          <Badge variant="secondary">One-to-One Matrix</Badge>
                          <span className="text-sm text-muted-foreground">
                      ...
                      {expandedMatrix === "oto" && (
                        <div className="p-4 border-t bg-muted/30">
                          <p className="text-sm text-muted-foreground">
                            Matrix preview will be displayed here. This would
                            show the one-to-one matrix data in a table format.
                          </p>
                        </div>
                      )}
                    </div>
                    ...
                    <div className="border rounded-lg overflow-hidden">
                      ...
                      >
                        <div className="flex items-center gap-3">
                          <Badge variant="secondary">Combination Matrix</Badge>
                          <span className="text-sm text-muted-foreground">
                            Combined referral and one-to-one data
                          </span>
                        </div>
                        <ChevronDown
                          className={cn(
                            "h-5 w-5 text-muted-foreground transition-transform",
                            expandedMatrix === "combination" && "rotate-180",
                          )}
                        />
                      </button>
                      {expandedMatrix === "combination" && (
                        <div className="p-4 border-t bg-muted/30">
                          <p className="text-sm text-muted-foreground">
                            Matrix preview will be displayed here. This would
                            show the combination matrix data in a table format.
                          </p>
                        </div>
                      )}
                    </div>
                    ...
                    <div className="border rounded-lg overflow-hidden">
                      <button
                        onClick={() =>
                          setExpandedMatrix(
                            expandedMatrix === "tyfcb" ? null : "tyfcb",
                          )
                        }
                        className="w-full flex items-center justify-between p-4 hover:bg-muted/50 transition-colors"
                      >
                        <div className="flex items-center gap-3">
                          <Badge variant="secondary">TYFCB Matrix</Badge>
                          <span className="text-sm text-muted-foreground">
                            Thank You For Closed Business tracking
                          </span>
                        </div>
                        <ChevronDown
                          className={cn(
                            "h-5 w-5 text-muted-foreground transition-transform",
                            expandedMatrix === "tyfcb" && "rotate-180",
                          )}
                        />
                      </button>
                      {expandedMatrix === "tyfcb" && (
                        <div className="p-4 border-t bg-muted/30">
                          <p className="text-sm text-muted-foreground">
                            Matrix preview will be displayed here. This would
                            show the TYFCB matrix data in a table format.
                          </p>
                        </div>
                      )}
                    </div>
                ...
                <div className="flex gap-3 justify-center pt-4">
                  <Button
                    variant="outline"
                    onClick={() => {
                      // Navigate to reports tab to view the report
                      onUploadSuccess();
                    }}
                  >
